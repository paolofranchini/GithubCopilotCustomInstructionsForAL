...
├── _index.instructions.md                    # Main landing page
├── README.instructions.md                    # This file - contribution guide
├── al-guidelines-rules.instructions.md       # Complete rules file with references to all categories
├── al-code-style.instructions.md             # Code style, formatting, and documentation rules
├── al-naming-conventions.instructions.md     # File naming, object naming, and variable naming
├── al-performance.instructions.md            # Performance optimization and query guidelines
...
- Update `al-guidelines-rules.instructions.md` to include `@your-new-file.instructions.md` reference
- Update `_index.instructions.md` to include links to new categories
...
*This README is part of the AI Coding for AL initiative - enhancing AL development through AI-optimized guidelines.* 
